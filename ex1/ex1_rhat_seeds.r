...
SEEDS <- c(42, 7, 101, 500, 1234, 2024, 8675, 31415)
cat("\nex1 stat_strong | rhat vs SEED | 2x RMS, tau ~ normal(0.05,0.05)+, ad=0.8, 1000/500, 4 chains\n")
cat("DGP err_scale = 3 (the overnight setting). Earlier fixed-seed(42) sweep: max rhat 1.06.\n\n")
out <- list()
...
saveRDS(res, "/private/tmp/claude-502/-Users-collin-Documents-Wake-Research-PriorPredictivePaper-reprod/0edcfb95-808f-4867-8f30-15ec1e2aec59/scratchpad/ex1_rhat_seeds.rds")
