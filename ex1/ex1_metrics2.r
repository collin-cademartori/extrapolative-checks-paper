...
saveRDS(res, "/private/tmp/claude-502/-Users-collin-Documents-Wake-Research-PriorPredictivePaper-reprod/0edcfb95-808f-4867-8f30-15ec1e2aec59/scratchpad/ex1_metrics2.rds")
...
for (m in c("gen_gap", "gen_gap_raw", "noise_abs_tr", "ovf_tr", "noise_abs", "ovf", "rgh")) {
...
for (m in c("gen_gap", "gen_gap_raw", "noise_abs_tr", "ovf_tr", "ovf", "rgh")) {
