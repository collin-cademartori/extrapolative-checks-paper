...
save(res, file = file.path(SP, "ex2_unitnorm_estsigma_pf.RData"))
res <- res[order(match(res$arm, c("fix", "est")), res$i), ]
cat("\nex2 INTERCEPTS model | UNIT-NORM variant | fixed vs ESTIMATED sigma | ad=0.8, no pathfinder | 6 datasets (sim .9, N_comp 2/3)\n")
