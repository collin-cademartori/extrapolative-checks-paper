...
SEEDS <- 201:208
ARMS <- c("clean_4", "ig_4", "clean_8")  # does inv-gamma or more chains kill the stochastic trapping?
...
ROWDIR <- file.path(SP, "ex2_repl_rows"); dir.create(ROWDIR, showWarnings = FALSE)  # crash-safe: one file per fit
...
save(res, file = file.path(SP, "ex2_unitnorm_replication.RData"))
